...
mysql 설치 중 오류 발생하면 vs code 라이브러리 설치
구글 검색 : Visual c++ redistributable v14 (vc_redist.x64.exe) 팔ㅇㅅ# Database26
데이터베이스학습용(mysql)
...
mysql 설치 중 오류 발생하면 vs code 라이브러리 설치
구글 검색 : Visual c++ redistributable v14 (vc_redist.x64.exe) 팔ㅇㅅ
